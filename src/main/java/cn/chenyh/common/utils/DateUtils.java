package cn.chenyh.common.utils;
...
public class DateUtils {
    ...
    public static String getCurrentDateStr(String pattern) throws ParseException {
        return DateUtils.dateFormat(new Date(),DateUtils.HOUR_PATTERN);
    }
