...
public class Response {
     ...
     * @return 返回结果
     */
    public static <T> ResponseResult<T> generate(final int code, final String message, T result) {
        return new ResponseResult<>(code, false, message, result);
    }
     ...
     * @return 响应结果
     */
    public static <T> ResponseResult<T> success(final String message, final T result) {
        return new ResponseResult<>(ResponseResultEnum.SUCCESS.getCode(), true, message, result);
    }
     ...
     * @return 响应结果
     */
    public static <T> ResponseResult<T> success(final T result) {
        return new ResponseResult<>(ResponseResultEnum.SUCCESS.getCode(), true, ResponseResultEnum.SUCCESS.getMessage(), result);
    }
     ...
     * @return 响应结果
     */
    public static <T> ResponseResult<T> failure(final int code, final String message, T result) {
        return new ResponseResult<>(code, false, message, result);
    }
